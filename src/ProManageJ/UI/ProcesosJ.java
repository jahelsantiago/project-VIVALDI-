 ...
 * @author ProBook
 */
public class ProcesosJ extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProcesosJ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
